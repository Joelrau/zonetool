...
namespace ZoneTool::H1
{
	...
	struct MaterialVertexStreamRouting
	{
		...
		ID3D11InputLayout PTR64 decl[250];
	};
	...
	struct MaterialTechniqueSet
	{
		...
		MaterialTechnique PTR64 techniques[240];
	...
	{
		Material PTR64 materials[3]; // mc, wc, wc (auto displacement)
	};
	...
	struct WeaponAttachment
	{
		...
		XModel PTR64 PTR64 reticleViewModels; // 48 (64 xmodels)
		snd_alias_list_t PTR64 PTR64 bounceSounds; // 56 (53 sounds)
		snd_alias_list_t PTR64 PTR64 rollingSounds; // 64 (53 sounds)
		AttChargeInfo PTR64 chargeInfo; // 72
		AttHybridSettings PTR64 hybridSettings; // 80
		scr_string_t PTR64 hideTags; // 88 (4 strings)
		scr_string_t PTR64 showTags; // 96 (4 strings)
		unsigned short PTR64 fieldOffsets; // 104
		WAField PTR64 fields; // 112
	...
	struct WeaponDef
	{
		...
		const char PTR64 szDisplayName; // 8
		const char PTR64 szAltWeaponName; // 16
		XModel PTR64 PTR64 gunModel; // 24 (2 xmodels)
		XModel PTR64 handModel; // 32
		XModel PTR64 persistentArmXModel; // 40
		XModel PTR64 PTR64 reticleViewModels; // 48 (64 xmodels)
		const char PTR64 lobWorldModelName; // 56
		XAnimParts PTR64 PTR64 szXAnimsRightHanded; // 64 (190 xanims)
		XAnimParts PTR64 PTR64 szXAnimsLeftHanded; // 72 (190 xanims)
		scr_string_t PTR64 hideTags; // 80 (32 xstrings)
		WeaponAttachment PTR64 PTR64 attachments; // 88 (weaponDef + 1332 attachments)
		XAnimParts PTR64 PTR64 szXAnims; // 96 (190 xanims)
		AnimOverrideEntry PTR64 animOverrides; // 104 (weaponDef + 1333 overrides)
		SoundOverrideEntry PTR64 soundOverrides; // 112 (weaponDef + 1334 overrides)
		FXOverrideEntry PTR64 fxOverrides; // 120 (weaponDef + 1335 overrides)
		ReloadStateTimerEntry PTR64 reloadOverrides; // 128 (weaponDef + 1336 overrides)
		NoteTrackToSoundEntry PTR64 notetrackOverrides; // 136 (weaponDef + 1337 overrides)
		scr_string_t PTR64 notetrackSoundMapKeys; // 144 (36 xstrings)
		scr_string_t PTR64 notetrackSoundMapValues; // 152 (36 xstrings)
		scr_string_t PTR64 notetrackRumbleMapKeys; // 160 (16 xstrings)
		scr_string_t PTR64 notetrackRumbleMapValues; // 168 (16 xstrings)
		scr_string_t PTR64 notetrackFXMapKeys; // 176 (16 xstrings)
		FxEffectDef PTR64 PTR64 notetrackFXMapValues; // 184 (16 effects)
		scr_string_t PTR64 notetrackFXMapTagValues; // 192 (16 xstrings)
		scr_string_t PTR64 notetrackHideTagKeys; // 200 (16 xstrings)
		bool PTR64 notetrackHideTagValues; // 208 (16 booleans)
		scr_string_t PTR64 notetrackHideTagTagValues; // 216 (16 xstrings)
		const char PTR64 szAdsrBaseSetting; // 224
		FxEffectDef PTR64 viewFlashEffect; // 232
		FxEffectDef PTR64 viewBodyFlashEffect; // 240
		FxEffectDef PTR64 worldFlashEffect; // 248
		FxEffectDef PTR64 viewFlashADSEffect; // 256
		FxEffectDef PTR64 viewBodyFlashADSEffect; // 264
		FxEffectDef PTR64 signatureViewFlashEffect; // 272
		FxEffectDef PTR64 signatureViewBodyFlashEffect; // 280
		FxEffectDef PTR64 signatureWorldFlashEffect; // 288
		FxEffectDef PTR64 signatureViewFlashADSEffect; // 296
		FxEffectDef PTR64 signatureViewBodyFlashADSEffect; // 304
		FxEffectDef PTR64 meleeHitEffect; // 312
		FxEffectDef PTR64 meleeMissEffect; // 320
		snd_alias_list_t PTR64 pickupSound; // 328 (74 sounds)
		snd_alias_list_t PTR64 pickupSoundPlayer; // 336
		snd_alias_list_t PTR64 ammoPickupSound; // 344
		snd_alias_list_t PTR64 ammoPickupSoundPlayer; // 352
		snd_alias_list_t PTR64 projectileSound; // 360
		snd_alias_list_t PTR64 pullbackSound; // 368
		snd_alias_list_t PTR64 pullbackSoundPlayer; // 376
		snd_alias_list_t PTR64 pullbackSoundQuick; // 384
		snd_alias_list_t PTR64 pullbackSoundQuickPlayer; // 392
		snd_alias_list_t PTR64 fireSound; // 400
		snd_alias_list_t PTR64 fireSoundPlayer; // 408
		snd_alias_list_t PTR64 fireSoundPlayerAkimbo; // 416
		snd_alias_list_t PTR64 fireMedSound; // 424
		snd_alias_list_t PTR64 fireMedSoundPlayer; // 432
		snd_alias_list_t PTR64 fireHighSound; // 440
		snd_alias_list_t PTR64 fireHighSoundPlayer; // 448
		snd_alias_list_t PTR64 fireLoopSound; // 456
		snd_alias_list_t PTR64 fireLoopSoundPlayer; // 464
		snd_alias_list_t PTR64 fireMedLoopSound; // 472
		snd_alias_list_t PTR64 fireMedLoopSoundPlayer; // 480
		snd_alias_list_t PTR64 fireHighLoopSound; // 488
		snd_alias_list_t PTR64 fireHighLoopSoundPlayer; // 496
		snd_alias_list_t PTR64 fireLoopEndPointSound; // 504
		snd_alias_list_t PTR64 fireLoopEndPointSoundPlayer; // 512
		snd_alias_list_t PTR64 fireStopSound; // 520
		snd_alias_list_t PTR64 fireStopSoundPlayer; // 528
		snd_alias_list_t PTR64 fireMedStopSound; // 536
		snd_alias_list_t PTR64 fireMedStopSoundPlayer; // 544
		snd_alias_list_t PTR64 fireHighStopSound; // 552
		snd_alias_list_t PTR64 fireHighStopSoundPlayer; // 560
		snd_alias_list_t PTR64 fireLastSound; // 568
		snd_alias_list_t PTR64 fireLastSoundPlayer; // 576
		snd_alias_list_t PTR64 fireFirstSound; // 584
		snd_alias_list_t PTR64 fireFirstSoundPlayer; // 592
		snd_alias_list_t PTR64 fireCustomSound; // 600
		snd_alias_list_t PTR64 fireCustomSoundPlayer; // 608
		snd_alias_list_t PTR64 emptyFireSound; // 616
		snd_alias_list_t PTR64 emptyFireSoundPlayer; // 624
		snd_alias_list_t PTR64 adsRequiredFireSoundPlayer; // 632
		snd_alias_list_t PTR64 meleeSwipeSound; // 640
		snd_alias_list_t PTR64 meleeSwipeSoundPlayer; // 648
		snd_alias_list_t PTR64 meleeHitSound; // 656
		snd_alias_list_t PTR64 meleeHitSoundPlayer; // 664
		snd_alias_list_t PTR64 meleeMissSound; // 672
		snd_alias_list_t PTR64 meleeMissSoundPlayer; // 680
		snd_alias_list_t PTR64 rechamberSound; // 688
		snd_alias_list_t PTR64 rechamberSoundPlayer; // 696
		snd_alias_list_t PTR64 reloadSound; // 704
		snd_alias_list_t PTR64 reloadSoundPlayer; // 712
		snd_alias_list_t PTR64 reloadEmptySound; // 720
		snd_alias_list_t PTR64 reloadEmptySoundPlayer; // 728
		snd_alias_list_t PTR64 reloadStartSound; // 736
		snd_alias_list_t PTR64 reloadStartSoundPlayer; // 744
		snd_alias_list_t PTR64 reloadEndSound; // 752
		snd_alias_list_t PTR64 reloadEndSoundPlayer; // 760
		snd_alias_list_t PTR64 detonateSound; // 768
		snd_alias_list_t PTR64 detonateSoundPlayer; // 776
		snd_alias_list_t PTR64 nightVisionWearSound; // 784
		snd_alias_list_t PTR64 nightVisionWearSoundPlayer; // 792
		snd_alias_list_t PTR64 nightVisionRemoveSound; // 800
		snd_alias_list_t PTR64 nightVisionRemoveSoundPlayer; // 808
		snd_alias_list_t PTR64 raiseSound; // 816
		snd_alias_list_t PTR64 raiseSoundPlayer; // 824
		snd_alias_list_t PTR64 firstRaiseSound; // 832
		snd_alias_list_t PTR64 firstRaiseSoundPlayer; // 840
		snd_alias_list_t PTR64 altSwitchSound; // 848
		snd_alias_list_t PTR64 altSwitchSoundPlayer; // 856
		snd_alias_list_t PTR64 putawaySound; // 864
		snd_alias_list_t PTR64 putawaySoundPlayer; // 872
		snd_alias_list_t PTR64 scanSound; // 880
		snd_alias_list_t PTR64 changeVariableZoomSound; // 888
		snd_alias_list_t PTR64 adsUpSound; // 896
		snd_alias_list_t PTR64 adsDownSound; // 904
		snd_alias_list_t PTR64 adsCrosshairEnemySound; // 912
		snd_alias_list_t PTR64 PTR64 bounceSound; // 920 (53 sounds)
		snd_alias_list_t PTR64 PTR64 rollingSound; // 928 (53 sounds)
		FxEffectDef PTR64 viewShellEjectEffect; // 936
		FxEffectDef PTR64 worldShellEjectEffect; // 944
		FxEffectDef PTR64 viewLastShotEjectEffect; // 952
		FxEffectDef PTR64 worldLastShotEjectEffect; // 960
		FxEffectDef PTR64 viewMagEjectEffect; // 968
		Material PTR64 reticleCenter; // 976
		Material PTR64 reticleSide; // 984
		XModel PTR64 PTR64 worldModel; // 992 (2 xmodels)
		XModel PTR64 worldClipModel; // 1000
		XModel PTR64 rocketModel; // 1008
		XModel PTR64 knifeModel; // 1016
		XModel PTR64 worldKnifeModel; // 1024
		Material PTR64 hudIcon; // 1032
		Material PTR64 pickupIcon; // 1040
		Material PTR64 minimapIconFriendly; // 1048
		Material PTR64 minimapIconEnemy; // 1056
		Material PTR64 minimapIconNeutral; // 1064
		Material PTR64 ammoCounterIcon; // 1072
		const char PTR64 szAmmoName; // 1080
		const char PTR64 szClipName; // 1088
		const char PTR64 szSharedAmmoCapName; // 1096
		PhysCollmap PTR64 physCollmap; // 1104
		PhysPreset PTR64 physPreset; // 1112
		const char PTR64 szUseHintString; // 1120
		const char PTR64 dropHintString; // 1128
		float PTR64 locationDamageMultipliers; // 1136 (22 floats)
		const char PTR64 fireRumble; // 1144
		const char PTR64 fireMedRumble; // 1152
		const char PTR64 fireHighRumble; // 1160
		const char PTR64 meleeImpactRumble; // 1168
		TracerDef PTR64 tracerType; // 1176
		TracerDef PTR64 signatureTracerType; // 1184
		LaserDef PTR64 laserType; // 1192
		snd_alias_list_t PTR64 turretOverheatSound; // 1200
		FxEffectDef PTR64 turretOverheatEffect; // 1208
		const char PTR64 turretBarrelSpinRumble; // 1216
		snd_alias_list_t PTR64 turretBarrelSpinMaxSnd; // 1224
		snd_alias_list_t PTR64 turretBarrelSpinUpSnd[4]; // 1232
		snd_alias_list_t PTR64 turretBarrelSpinDownSnd[4]; // 1264
		snd_alias_list_t PTR64 missileConeSoundAlias; // 1296
		snd_alias_list_t PTR64 missileConeSoundAliasAtBase; // 1304
		XModel PTR64 stowOffsetModel; // 1312
		TurretHydraulicSettings PTR64 turretHydraulicSettings; // 1320
		int altWeapon; // 1328
		...
		float pad1; // 2612 X
		Material PTR64 killIcon; // 2616
		Material PTR64 dpadIcon; // 2624
		Material PTR64 hudProximityWarningIcon; // 2632
		...
		float pad2; // 2740 X
		const char PTR64 projectileName; // 2744
		XModel PTR64 projectileModel; // 2752
		FxEffectDef PTR64 projExplosionEffect; // 2760
		FxEffectDef PTR64 projDudEffect; // 2768
		snd_alias_list_t PTR64 projExplosionSound; // 2776
		snd_alias_list_t PTR64 projDudSound; // 2784
		...
		float PTR64 parallelBounce; // 2816 (53 floats)
		float PTR64 perpendicularBounce; // 2824 (53 floats)
		FxEffectDef PTR64 projTrailEffect; // 2832
		FxEffectDef PTR64 projBeaconEffect; // 2840
		...
		FxEffectDef PTR64 projIgnitionEffect; // 2872
		snd_alias_list_t PTR64 projIgnitionSound; // 2880
		...
		float maxDist; // 3068
		const char PTR64 accuracyGraphName[2]; // 3072
		...
		const char PTR64 szScript; // 3224
		int minDamage; // 3232
		int midDamage; // 3236
...
#pragma pack(pop)
	...
	struct /*alignas(128)*/ clipMap_t
	{
		...
		int isInUse; // 8
		ClipInfo info; // 16
		ClipInfo PTR64 pInfo; // 264
		unsigned int numNodes; // 272
		cNode_t PTR64 nodes; // 280
		unsigned int numLeafs; // 288
		cLeaf_t PTR64 leafs; // 296
		unsigned int numSubModels; // 304
		cmodel_t PTR64 cmodels; // 312
		MapEnts PTR64 mapEnts; // 320
		Stage PTR64 stages; // 328
		...
		scr_string_t PTR64 dynEntAnchorNames; // 472
	...
	struct GfxWorldVertexData
	{
		...
		ID3D11ShaderResourceView PTR64 worldVbView;
	...
	struct GfxWorldVertexLayerData
	{
		...
		ID3D11ShaderResourceView PTR64 layerVbView;
	...
	struct GfxWorldDraw
	{
		...
		GfxDisplacementParms PTR64 displacementParms;
		ID3D11Buffer PTR64 displacementParmsBuffer;
		ID3D11ShaderResourceView PTR64 displacementParmsBufferView;
	...
	struct GfxWorldDpvsStatic
	{
		...
		unsigned int PTR64 smodelVisData[4]; // 72 80 88 96
		unsigned int PTR64 smodelUnknownVisData[27];
		unsigned int PTR64 surfaceVisData[4]; // 320 328 336 344
		unsigned int PTR64 surfaceUnknownVisData[27];
		unsigned int PTR64 smodelUmbraVisData[4]; // 568 576 584 592
		unsigned int PTR64 surfaceUmbraVisData[4]; // 600 608 616 624
		unsigned int PTR64 lodData; // 632
		unsigned int PTR64 tessellationCutoffVisData; // 640
		unsigned int PTR64 sortedSurfIndex; // 648
		GfxStaticModelInst PTR64 smodelInsts; // 656
		GfxSurface PTR64 surfaces; // 664
		GfxSurfaceBounds PTR64 surfacesBounds; // 672
		GfxStaticModelDrawInst PTR64 smodelDrawInsts; // 680
		unsigned int PTR64 unknownSModelVisData1; // 688
		unsigned int PTR64 unknownSModelVisData2; // 696
		GfxStaticModelLighting PTR64 smodelLightingInsts; // 704 (array)
		GfxSubdivVertexLightingInfo PTR64 subdivVertexLighting; // 712 (array)
		GfxDrawSurf PTR64 surfaceMaterials; // 720
		unsigned int PTR64 surfaceCastsSunShadow; // 728
		unsigned int sunShadowOptCount; // 736
		unsigned int sunSurfVisDataCount; // 740
		unsigned int PTR64 surfaceCastsSunShadowOpt; // 744
		GfxDepthAndSurf PTR64 surfaceDeptAndSurf; // 752
		GfxWorldDpvsVoid PTR64 constantBuffersLit; // 760
		GfxWorldDpvsVoid PTR64 constantBuffersAmbient; // 768
		int usageCount; // 776
	...
	{
		FxEffectDef PTR64 nonflesh[53];
		FxEffectDef PTR64 flesh[7];
	};

	struct FxImpactTable
	{
		const char PTR64 name;
		FxImpactEntry PTR64 table; // size: 19
	};

	struct SurfaceFxEntry
	{
		FxEffectDef PTR64 surfaceEffect[53];
	};
	...
	struct SndSubmixList
	{
		union
		{
			const char PTR64 submixName;
			const char PTR64 name;
		};
		SndSubmix PTR64 head;
		int count;
