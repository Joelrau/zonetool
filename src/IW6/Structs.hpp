...
namespace ZoneTool::IW6
{
	...
	struct MaterialVertexStreamRouting
	{
		...
		ID3D11InputLayout PTR64 decl[249];
	};
	...
	struct MaterialTechniqueSet
	{
		...
		MaterialTechnique PTR64 techniques[412];
	};
	...
	struct Material
	{
		...
		MaterialTechniqueSet PTR64 techniqueSet; // 464
		MaterialTextureDef PTR64 textureTable; // 472
		MaterialConstantDef PTR64 constantTable; // 480
		GfxStateBits PTR64 stateMap; // 488 (stateBitsTable)
		unsigned char constantBufferIndex[412]; // 496
		char __pad3[4]; // 500
		MaterialConstantBufferDef PTR64 constantBufferTable; // 912
		unsigned char constantBufferCount; // 920
		char __pad4[7]; // 921-928
		const char PTR64 PTR64 subMaterials; // 928
	};
	...
	{
		GfxQuantizedNoColorVertex PTR64 quantizedNoColorVerts0;
		GfxQuantizedNoColorMotionVertex PTR64 quantizedNoColorMotionVerts0;
		GfxQuantizedVertex PTR64 quantizedVerts0;
		GfxQuantizedMotionVertex PTR64 quantizedMotionVerts0;
	...
	struct XSurface
	{
		...
		Face PTR64 triIndices; // 32
		ID3D11Buffer PTR64 vb0; // 40
		ID3D11ShaderResourceView PTR64 vb0View; // 48
		ID3D11Buffer PTR64 indexBuffer; // 56
		XRigidVertList PTR64 rigidVertLists; // 64
		XBlendInfo PTR64 blendVerts; // 72
		...
		float PTR64 tensionData; // 136
		unsigned short PTR64 tensionAccumTable; // 144
		ID3D11Buffer PTR64 tensionAccumTableBuffer; // 152
		ID3D11ShaderResourceView PTR64 tensionAccumTableView; // 160
		ID3D11Buffer PTR64 tensionDataBuffer; // 168
		ID3D11ShaderResourceView PTR64 tensionDataView; // 176
		ID3D11ShaderResourceView PTR64 indexBufferView; // 184
	...
	struct PhysGeomInfo
	{
		BrushWrapper PTR64 brushWrapper;
		int type;
	...
	struct XModel
	{
		...
		scr_string_t PTR64 boneNames; // 48
		unsigned char PTR64 parentList; // 56
		XModelAngle PTR64 tagAngles; // 64
		XModelTagPos PTR64 tagPositions; // 72
		unsigned char PTR64 partClassification; // 80
		DObjAnimMat PTR64 baseMat; // 88
		ReactiveMotionModelPart PTR64 reactiveMotionParts; // 96
		Material PTR64 PTR64 materialHandles; // 104
		...
		XModelCollSurf_s PTR64 collSurfs; // 504
		int contents; // 512
		XBoneInfo PTR64 boneInfo; // 520
		float radius; // 528
		Bounds bounds; // 532
		unsigned short PTR64 invHighMipRadius; // 560
		int memUsage; // 568
		PhysPreset PTR64 physPreset; // 576
		PhysCollmap PTR64 physCollmap; // 584
	...
	struct snd_alias_t
	{
		...
		OcclusionShape PTR64 occlusionShape;
	...
	{
		float origin[3];
		GfxReflectionProbeVolumeData PTR64 probeVolumes;
	...
	struct GfxWorldDraw
	{
		...
		GfxTexture PTR64 reflectionProbeTextures;
		...
		GfxTexture PTR64 lightmapPrimaryTextures;
		GfxTexture PTR64 lightmapSecondaryTextures;
	...
	struct GfxStaticModelVertexLightingInfo
	{
		...
		ID3D11Buffer PTR64 lightingValuesSb;
		unsigned int subdiv_count_maybe;
		ID3D11Buffer PTR64 subDivCacheBuffer;
		ID3D11ShaderResourceView PTR64 subDivCacheViewBuffer;
		int flags;
	...
	struct GfxWorldDpvsStatic
	{
		...
		GfxSurfaceBounds PTR64 surfacesBounds; // 208
		GfxStaticModelDrawInst PTR64 smodelDrawInsts; // 216
		GfxDrawSurf PTR64 surfaceMaterials; // 224
		unsigned int PTR64 surfaceCastsSunShadow; // 232
		unsigned int sunShadowOptCount; // 240
		unsigned int sunSurfVisDataCount; // 244
		unsigned int PTR64 surfaceCastsSunShadowOpt; // 248
		char PTR64 PTR64 constantBuffersLit; // 256
		char PTR64 PTR64 constantBuffersAmbient; // 264
	...
	struct GfxWorldDpvsDynamic
	{
		...
		unsigned char PTR64 dynEntVisData[2][3];
	};
	...
	struct GfxWorld
	{
		...
		GfxCellTreeCount PTR64 aabbTreeCounts; // 112
		GfxCellTree PTR64 aabbTrees; // 120
		GfxCell PTR64 cells; // 128
		GfxWorldDraw draw; // 136
		GfxLightGrid lightGrid; // 312
		int modelCount; // 1880
		GfxBrushModel PTR64 models; // 1888
		Bounds bounds; // 1896
		unsigned int checksum; // 1920
		int materialMemoryCount; // 1924
		MaterialMemory PTR64 materialMemory; // 1928
		sunflare_t sun; // 1936
		float outdoorLookupMatrix[4][4]; // 2160
		GfxImage PTR64 outdoorImage; // 2176
		unsigned int PTR64 cellCasterBits; // 2120
		unsigned int PTR64 cellHasSunLitSurfsBits; // 2128
		GfxSceneDynModel PTR64 sceneDynModel; // 2136
		GfxSceneDynBrush PTR64 sceneDynBrush; // 2144
		unsigned int PTR64 primaryLightEntityShadowVis; // 2152
		unsigned int PTR64 primaryLightDynEntShadowVis[2]; // 2160
		unsigned short PTR64 nonSunPrimaryLightForModelDynEnt; // 2176
		GfxShadowGeometry PTR64 shadowGeom; // 2184
		GfxShadowGeometry PTR64 shadowGeomOptimized; // 2192
		GfxLightRegion PTR64 lightRegion; // 2200
		...
		GfxHeroOnlyLight PTR64 heroOnlyLights; // 2520
		unsigned char fogTypesAllowed; // 2528
		unsigned int umbraTomeSize; // 2588
		char PTR64 umbraTomeData; // 2592
	...
	struct ClipInfo
	{
		...
		unsigned short PTR64 leafbrushes;
	...
	struct DynEntityDef
	{
		DynEntityType type;
		GfxPlacement pose;
		XModel PTR64 baseModel; //const XModel PTR64 baseModel;
		unsigned short brushModel;
		unsigned short physicsBrushModel;
		unsigned short scriptableIndex;
		unsigned short health;
		FxEffectDef PTR64 destroyFx; //const FxEffectDef PTR64 destroyFx;
		PhysPreset PTR64 physPreset;
	...
	struct Hinge
	{
		...
		DynEntityHingeDef PTR64 def; //const DynEntityHingeDef PTR64 def;
		PhysPreset PTR64 physPreset; //const PhysPreset PTR64 physPreset;
	...
	struct DynEntityClient
	{
		...
		unsigned short health;
		Hinge PTR64 hinge;
		XModel PTR64 activeModel; //const XModel PTR64 activeModel;
		int contents;
	};
	...
	{
		FxEffectDef PTR64 handle; //const FxEffectDef PTR64 handle;
	...
	struct WeaponDef
	{
		...
		XModel PTR64 PTR64 gunXModel;
		XModel PTR64 handXModel;
		XModel PTR64 camoWorldModel;
		XModel PTR64 camoViewModel;
		Material PTR64 camoWorldModelMaterialOverride;
		Material PTR64 camoViewModelMaterialOverride;
		Material PTR64 PTR64 camoMaterialTarget;
		XAnimParts PTR64 PTR64 szXAnimsRightHanded;
		XAnimParts PTR64 PTR64 szXAnimsLeftHanded;
		const char PTR64 szModeName;
		scr_string_t PTR64 notetrackSoundMapKeys;
		scr_string_t PTR64 notetrackSoundMapValues;
		scr_string_t PTR64 notetrackRumbleMapKeys;
		scr_string_t PTR64 notetrackRumbleMapValues;
		scr_string_t PTR64 notetrackFXMapKeys;
		FxEffectDef PTR64 PTR64 notetrackFXMapValues; // const FxEffectDef PTR64 PTR64 
		scr_string_t PTR64 notetrackFXMapTagValues;
		int playerAnimType;
		weapType_t weapType;
		...
		const FxEffectDef PTR64 viewFlashEffect;
		const FxEffectDef PTR64 worldFlashEffect;
		const FxEffectDef PTR64 viewFlashADSEffect;
		...
		snd_alias_list_t PTR64 PTR64 bounceSound;
		snd_alias_list_t PTR64 PTR64 rollingSound;
		const FxEffectDef PTR64 viewShellEjectEffect;
		const FxEffectDef PTR64 worldShellEjectEffect;
		const FxEffectDef PTR64 viewLastShotEjectEffect;
		const FxEffectDef PTR64 worldLastShotEjectEffect;
		const FxEffectDef PTR64 viewMagEjectEffect;
		...
		const FxEffectDef PTR64 projExplosionEffect;
		const FxEffectDef PTR64 projDudEffect;
		...
		float PTR64 parallelBounce;
		float PTR64 perpendicularBounce;
		const FxEffectDef PTR64 projTrailEffect;
		const FxEffectDef PTR64 projBeaconEffect;
		float vProjectileColor[3];
		guidedMissileType_t guidedMissileType;
		float maxSteeringAccel;
		int projIgnitionDelay;
		const FxEffectDef PTR64 projIgnitionEffect;
	...
	struct WeaponAttachment
	{
		...
		weapClass_t weapClass;
		XModel PTR64 PTR64 worldModels;
		XModel PTR64 PTR64 viewModels;
		XModel PTR64 PTR64 reticleViewModels;
		...
		AttLocationDamage PTR64 locationDamage;
	...
	struct FXOverrideEntry
	{
		unsigned short attachment1;
		unsigned short attachment2;
		const FxEffectDef PTR64 overrideFX;
		const FxEffectDef PTR64 altmodeFX;
		unsigned int fxType;
	};
	...
	struct WeaponCompleteDef
	{
		...
		WeaponAttachment PTR64 PTR64 scopes;
		WeaponAttachment PTR64 PTR64 underBarrels;
		WeaponAttachment PTR64 PTR64 others;
		XAnimParts PTR64 PTR64 szXAnims; // XAnimParts PTR64 const PTR64 
	...
	struct VehicleDef
	{
		...
		const FxEffectDef PTR64 trophyExplodeFx;
		const FxEffectDef PTR64 trophyFlashFx;
		...
		snd_alias_list_t PTR64 surfaceSnds[31];
	...
	union XAssetHeader
	{
		...
		//VehicleTrack PTR64 vehicleTrack;
		MapEnts PTR64 mapEnts;
		...
		//Colorization PTR64 colorization;
		//ColorizationSet PTR64 colorizationSet;
		//ToneMapping PTR64 toneMapping;
	...
	struct XGfxGlobals
	{
		...
		std::uint64_t PTR64 depthStencilStateBits; // 8
		GfxBlendStateBits PTR64 blendStateBits; // 16
		GfxZoneTableEntry PTR64 depthStencilStates; // 24
		GfxZoneTableEntry PTR64 blendStates; // 32
		...
		unsigned int PTR64 perPrimConstantBufferSizes; // 56
		unsigned int PTR64 perObjConstantBufferSizes; // 64
		unsigned int PTR64 stableConstantBufferSizes; // 72
		GfxZoneTableEntry PTR64 perPrimConstantBuffers; // 80
		GfxZoneTableEntry PTR64 perObjConstantBuffers; // 88
		GfxZoneTableEntry PTR64 stableConstantBuffers; // 96
	};
