...
namespace ZoneTool::IW7
{
	...
	struct XModel
	{
		...
		char PTR64 physicsLODData;
		unsigned int physicsLODDataNameCount;
		scr_string_t PTR64 physicsLODDataNames;
	...
	struct MayhemAnimFramesSplineCompressed
	{
		char PTR64 diskQuat;
		char PTR64 diskPos;
		unsigned short PTR64 diskQuatFrames;
		unsigned short PTR64 diskPosFrames;
		unsigned short PTR64 numDiskQuatFrames;
		unsigned short PTR64 numDiskPosFrames;
	...
	{
		char PTR64 keys;
		unsigned short PTR64 numKeys;
		unsigned short PTR64 keyFrames;
	...
	enum MaterialTechniqueType
	{
		...
		// 74
		// 75
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS = 76,
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS_VELOCITY_RIGID = 77,
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS_VELOCITY_SKINNED = 78,
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS_OBJECTID = 79,
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS_OBJECTID_VELOCITY_RIGID = 80,
		TECHNIQUE_SUBDIV_PATCH_DEPTH_PREPASS_OBJECTID_VELOCITY_SKINNED = 81,
		TECHNIQUE_SUBDIV_PATCH_BUILD_SHADOWMAP_DEPTH = 82,
		TECHNIQUE_SUBDIV_PATCH_BUILD_SHADOWMAP_COLOR = 83,
		TECHNIQUE_SUBDIV_PATCH_UNLIT = 84,
		TECHNIQUE_SUBDIV_PATCH_UNLIT_UNK = 85,
		TECHNIQUE_SUBDIV_PATCH_EMISSIVE = 86,
		TECHNIQUE_SUBDIV_PATCH_EMISSIVE_UNK = 87,
		TECHNIQUE_SUBDIV_PATCH_EMISSIVE_DEBUG = 88,
		TECHNIQUE_SUBDIV_PATCH_LIT = 89,
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 90
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 91
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 92
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 93
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 94
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 95
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 96
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 97
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 98
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 99
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 100
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 101
		//TECHNIQUE_SUBDIV_PATCH_LIT_ = 102
		TECHNIQUE_SUBDIV_PATCH_THERMAL = 103,
		TECHNIQUE_SUBDIV_PATCH_VELOCITY_RIGID = 104,
		TECHNIQUE_SUBDIV_PATCH_VELOCITY_SKINNED = 105,
		TECHNIQUE_SUBDIV_PATCH_DEBUG_BUMPMAP = 106,
		// 107
		// 108
		// 109
		// 110
	...
	enum ShaderCodeConstants : std::int32_t
	{
		...
		CONST_SRC_CODE_LIGHT_IES_LOOKUP,
		CONST_SRC_CODE_LIGHT_PHYSICALSIZE,
		CONST_SRC_CODE_LIGHT_FADEOFFSET,
		CONST_SRC_CODE_SUN_LIGHT_DIR,
		CONST_SRC_CODE_SUN_LIGHT_COLOR_AND_UV,
		CONST_SRC_CODE_ENTITY_ID,
		CONST_SRC_CODE_EMBLEM_PARAMS_0,
		CONST_SRC_CODE_EMBLEM_PARAMS_1,
		CONST_SRC_CODE_PARTICLE_CLOUD_COLOR,
		CONST_SRC_CODE_GAMETIME,
		CONST_SRC_CODE_SCRIPTABLE_BASE_PASS_COLOR,
		CONST_SRC_CODE_MATERIAL_ENTITY_POSITION,
		CONST_SRC_CODE_EYEOFFSET,
		CONST_SRC_CODE_CHECKERBOARD_INDEX,
		CONST_SRC_CODE_WORLD_MATRIX_EYE_OFFSET,
		CONST_SRC_CODE_LOD_PARAMS,
		CONST_SRC_CODE_MATERIAL_LOD_PARAMS,
		CONST_SRC_CODE_MISC_OBJECT_PARAMS,
		CONST_SRC_CODE_PACKED_LIGHT_COUNT,
		CONST_SRC_CODE_SHADOW_ARRAY_INDEX,
		CONST_SRC_CODE_MODEL_MOTIONBLUR_VELOCITY_PARMS,
		CONST_SRC_CODE_HUD_OUTLINE_PARMS,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_IN_SCOPE,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_IN_SCOPE_FOE,
		CONST_SRC_CODE_HUD_OUTLINE_FILL_COLOR_0,
		CONST_SRC_CODE_HUD_OUTLINE_FILL_COLOR_1,
		CONST_SRC_CODE_HUD_OUTLINE_OCCLUDED_OUTLINE_COLOR,
		CONST_SRC_CODE_HUD_OUTLINE_OCCLUDED_INLINE_COLOR,
		CONST_SRC_CODE_HUD_OUTLINE_OCCLUDED_INTERIOR,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_PARMS,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_FILL_COLOR_0,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_FILL_COLOR_1,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_OCCLUDED_OUTLINE_COLOR,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_OCCLUDED_INLINE_COLOR,
		CONST_SRC_CODE_HUD_OUTLINE_SCOPE_OCCLUDED_INTERIOR,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_NOISE_PARMS,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_DARK_COLOR_ENEMY,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_BRIGHT_COLOR_ENEMY,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_DARK_COLOR_FRIEND,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_BRIGHT_COLOR_FRIEND,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_DARK_COLOR_BACKGROUND,
		CONST_SRC_CODE_HUD_OUTLINE_THERMAL_BRIGHT_COLOR_BACKGROUND,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_0,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_1,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_2,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_3,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_4,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_5,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_6,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_7,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_8,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_9,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_10,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_11,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_12,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_13,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_14,
		CONST_SRC_CODE_HUD_OUTLINE_COLOR_TABLE_15,
		...
		CONST_SRC_CODE_FIRST_UI_MASK_TRANSFORM,
		CONST_SRC_CODE_UI_MASK_TRANSLATION,
		CONST_SRC_CODE_SECOND_UI_MASK_TRANSFORM,
		CONST_SRC_CODE_UI_MASK_ALPHA_SCALE,
		CONST_SRC_CODE_CURVED_HUD_SEMIAXES_AND_CORNER_LENGTH,
		CONST_SRC_CODE_CURVED_HUD_OPERATOR_MASK,
		CONST_SRC_CODE_USE_UI_POST_PARAMS0,
		CONST_SRC_CODE_USE_UI_POST_PARAMS1,
		CONST_SRC_CODE_USE_UI_POST_PARAMS2,
		CONST_SRC_CODE_USE_UI_POST_PARAMS3,
		CONST_SRC_CODE_USE_UI_POST_PARAMS4,
		CONST_SRC_CODE_USE_UI_POST_PARAMS5,
		CONST_SRC_CODE_UI_UV_TRANSFORM0,
		CONST_SRC_CODE_UI_UV_TRANSFORM1,
		...
		CONST_SRC_CODE_RENDER_VIEWPORT_SIZE,
		...
		CONST_SRC_CODE_LIGHTING_SCALE,
		CONST_SRC_CODE_SHADER_LOD_SCALE,
		CONST_SRC_CODE_SECONDARY_SELFVIS_SCALE,
		CONST_SRC_CODE_SH_BAND_SCALE,
		CONST_SRC_CODE_VOLUMETRIC_DEPTH,
		CONST_SRC_CODE_VOLUMETRIC_DEPTH_RCP,
		CONST_SRC_CODE_FRUSTUM_GRID_CLUSTER_SIZE,
		CONST_SRC_CODE_FRUSTUM_GRID_LIGHT_PARAMS,
		CONST_SRC_CODE_MOTION_MATRIX_X,
		CONST_SRC_CODE_MOTION_MATRIX_Y,
		CONST_SRC_CODE_MOTION_MATRIX_W,
		CONST_SRC_CODE_REFLECTION_PROBE_NORMALIZE_PARAMS,
		...
		CONST_SRC_CODE_DECAL_VOLUMES_PARAMS,
		...
		CONST_SRC_CODE_SUNSHADOW_SWITCH_PARTITION_NEAR,
		CONST_SRC_CODE_SUNSHADOW_SWITCH_PARTITION_FAR,
		CONST_SRC_CODE_SUNSHADOW_SWITCH_PARTITION_DISTANT,
		CONST_SRC_CODE_SUNSHADOW_SWITCH_PARTITION_TRANS,
		CONST_SRC_CODE_SUNSHADOW_EYE_OFFSET_NEAR,
		CONST_SRC_CODE_SUNSHADOW_EYE_OFFSET_FAR,
		CONST_SRC_CODE_SUNSHADOW_EYE_OFFSET_DISTANT,
		CONST_SRC_CODE_SUNSHADOW_EYE_OFFSET_TRANS,
		CONST_SRC_CODE_SUNSHADOW_BLEND_SCALE_NEAR,
		CONST_SRC_CODE_SUNSHADOW_BLEND_SCALE_FAR,
		CONST_SRC_CODE_SUNSHADOW_BLEND_SCALE_DISTANT,
		CONST_SRC_CODE_SUNSHADOW_BLEND_SCALE_TRANS,
		CONST_SRC_CODE_SUNSHADOW_TRANSMISSIVE_TINT,
		CONST_SRC_CODE_SUN_SHADOWMAP_SIZE,
		CONST_SRC_CODE_SUN_SHADOWMAP_FILTER_RADIUS,
		CONST_SRC_CODE_CLOUD_SHADOW_LOOKUP_MATRIX_R0,
		CONST_SRC_CODE_CLOUD_SHADOW_LOOKUP_MATRIX_R1,
		CONST_SRC_CODE_CLOUD_SHADOW_PARAMS,
		CONST_SRC_CODE_STATIC_SUN_SHADOW_PENUMBRA,
		CONST_SRC_CODE_SUN_HEIGHTFIELD_PARAMS,
		CONST_SRC_CODE_STATIC_SUN_SHADOW_PARAMS0,
		CONST_SRC_CODE_STATIC_SUN_SHADOW_PARAMS1,
		CONST_SRC_CODE_STATIC_SUN_SHADOW_PARAMS2,
		CONST_SRC_CODE_ZPLANES,
		CONST_SRC_CODE_VIEWSPACE_SCALE_BIAS,
		CONST_SRC_CODE_LIGHTING_LOOKUP_SCALE,
		CONST_SRC_CODE_INV_SCENE_PROJECTION,
		CONST_SRC_CODE_CODE_VIEW_AXIS_X,
		CONST_SRC_CODE_CODE_VIEW_AXIS_Y,
		CONST_SRC_CODE_CODE_VIEW_AXIS_Z,
		CONST_SRC_CODE_RIM_LIGHT_PARAMS,
		CONST_SCR_CODE_HDR_SKY_INTENSITY,
		CONST_SRC_CODE_DEBUG_PARAMETERS0,
		CONST_SRC_CODE_DEBUG_PARAMETERS1,
		CONST_SRC_CODE_DEBUG_PARAMETERS_COLOR,
		CONST_SRC_CODE_MATERIAL_COLOR,
		CONST_SRC_CODE_FOG,
		CONST_SRC_CODE_FOG_COLOR,
		CONST_SRC_CODE_FOG_SUN_CONSTS,
		CONST_SRC_CODE_FOG_SUN_COLOR,
		CONST_SRC_CODE_FOG_SUN_DIR,
		CONST_SRC_CODE_FOG_HEIGHT,
		CONST_SRC_CODE_SKY_BLEND_CONSTS,
		CONST_SRC_CODE_SKY_ROTATION_MATRIX_INVERSE_R0,
		CONST_SRC_CODE_SKY_ROTATION_MATRIX_INVERSE_R1,
		CONST_SRC_CODE_SKY_ROTATION_MATRIX_INVERSE_R2,
		CONST_SRC_CODE_GLARE_APPLY,
		CONST_SRC_CODE_PERCEPTUAL_PARMS,
		CONST_SRC_CODE_TONEMAP_PARMS,
		CONST_SRC_CODE_TONEMAP_DEBUG,
		CONST_SRC_CODE_FILM_GRAIN_PARAMS,
		...
		CONST_SRC_CODE_PLAYERSHADOW_PROXY0_PARAMS,
		CONST_SRC_CODE_PLAYERSHADOW_PROXY1_PARAMS,
		CONST_SRC_CODE_PLAYERSHADOW_PROXY_PLANE_POS,
		CONST_SRC_CODE_PLAYERSHADOW_PROXY_PLANE_NORMAL,
		CONST_SRC_CODE_SUNSHADOW_PARAMS,
		CONST_SRC_CODE_UV_OFFSET,
		CONST_SRC_CODE_COMPOSITE_FX_DISTORTION0,
		CONST_SRC_CODE_COMPOSITE_FX_DISTORTION1,
		CONST_SRC_CODE_CHROMATIC_ABERRATION_PARAMS,
		CONST_SRC_CODE_VIEWPORT_DIMENSIONS,
		CONST_SRC_CODE_FRAMEBUFFER_READ,
		CONST_SRC_CODE_CINEMATIC_UV_OFFSET,
		CONST_SRC_CODE_THERMAL_FADE_CONTROL,
		CONST_SRC_CODE_THERMAL_FADE_COLOR,
		CONST_SRC_CODE_DUST_SHADER_DIRECTION,
		CONST_SRC_CODE_DUST_SHADER_TANGENT,
		CONST_SRC_CODE_DUST_SHADER_BINORMAL,
		CONST_SRC_CODE_DUST_SHADER_TILING,
		CONST_SRC_CODE_PLAYLIST_POPULATION_PARAMS,
		CONST_SRC_CODE_TESSELLATION_PARMS,
		CONST_SRC_CODE_TESSELLATION_PARMS2,
		CONST_SRC_CODE_SH_PROBE_PARAMS,
		CONST_SRC_CODE_EMBLEM_TEXTURE_ARRAY_INDEX,
		CONST_SRC_CODE_DEPTH_SCAN_COLOR,
		CONST_SRC_CODE_DEPTH_SCAN_OUTLINE_COLOR,
		CONST_SRC_CODE_DEPTH_SCAN_SCREEN_OVERLAY_COLOR,
		CONST_SRC_CODE_DEPTH_SCAN_PARAMS,
		CONST_SRC_CODE_DEPTH_SCAN_SCROLL_PARAMS,
		CONST_SRC_CODE_DEPTH_SCAN_SCOPE_STENCIL,
		CONST_SRC_CODE_SSSS_MATERIAL_PARAMS,
		...
		CONST_SRC_CODE_SUN_SHADOW_LOOKUP_MATRIX,
		CONST_SRC_CODE_INVERSE_SUN_SHADOW_LOOKUP_MATRIX,
		CONST_SRC_CODE_TRANSPOSE_SUN_SHADOW_LOOKUP_MATRIX,
		CONST_SRC_CODE_INVERSE_TRANSPOSE_SUN_SHADOW_LOOKUP_MATRIX,
	...
	enum MaterialTextureSource : std::int32_t
	{
		...
		TEXTURE_SRC_CODE_IES_LOOKUP,
		TEXTURE_SRC_CODE_LIGHTMAP_PRIMARY,
		TEXTURE_SRC_CODE_LIGHTMAP_SECONDARY,
		TEXTURE_SRC_CODE_LIGHTMAP_SECONDARY_UNORM,
		TEXTURE_SRC_CODE_SUN_SHADOWMAP_ARRAY,
		TEXTURE_SRC_CODE_SUN_SHADOWMAP_VIEWMODEL_CASCADE,
		TEXTURE_SRC_CODE_SUN_VISIBILITY,
		TEXTURE_SRC_CODE_SUN_EXTINCTION,
		TEXTURE_SRC_CODE_SUN_TRANSMITTANCE,
		TEXTURE_SRC_CODE_SUN_HEIGHTFIELD,
		TEXTURE_SRC_CODE_SUN_CLOUD,
		TEXTURE_SRC_CODE_SPOT_SHADOWMAP_ARRAY,
		TEXTURE_SRC_CODE_PREPASS_COLOR,
		...
		TEXTURE_SRC_CODE_DUST_COLOR,
		TEXTURE_SRC_CODE_DUST_NORMAL,
		TEXTURE_SRC_CODE_OUTDOOR,
		TEXTURE_SRC_CODE_FLOATZ,
		TEXTURE_SRC_CODE_FLOATZ_HALF,
		TEXTURE_SRC_CODE_FLOATZ_QUARTER,
		TEXTURE_SRC_CODE_PACKED_STENCIL,
		...
		TEXTURE_SRC_CODE_FIRST_UI_MASK,
		TEXTURE_SRC_CODE_SECOND_UI_MASK,
		TEXTURE_SRC_CODE_MACROCLUT,
		TEXTURE_SRC_CODE_PIP_SCENE,
		TEXTURE_SRC_CODE_VEIL_LUMINANCE,
		...
		TEXTURE_SRC_CODE_POSTFX_TEXTURE_4,
		TEXTURE_SRC_CODE_DEPTH_BLUR_0,
		TEXTURE_SRC_CODE_DEPTH_BLUR_1,
		TEXTURE_SRC_CODE_VOLUMETRIC_SCATTER,
		TEXTURE_SRC_CODE_VOLUMETRIC_EXTINCTION,
		TEXTURE_SRC_CODE_DEFAULT_DEPTH,
		...
		TEXTURE_SRC_CODE_LINEAR_MIP_CLAMP,
		TEXTURE_SRC_CODE_LINEAR_MIP_LINEAR_WRAP,
		TEXTURE_SRC_CODE_LINEAR_MIP_LINEAR_CLAMP,
		TEXTURE_SRC_CODE_GGX_ENV_BRDF,
		TEXTURE_SRC_CODE_GTSO_LUT,
		TEXTURE_SRC_CODE_FONT_CACHE,
		TEXTURE_SRC_CODE_DECAL_PRIMARY_CHANNEL,
		TEXTURE_SRC_CODE_DECAL_SECONDARY_CHANNEL,
		TEXTURE_SRC_CODE_DEFAULT_THIN_FILM_LUT,
		TEXTURE_SRC_CODE_SCENE_ALBEDO,
		TEXTURE_SRC_CODE_SCENE_SPECULAR,
		TEXTURE_SRC_CODE_SCENE_DIFFUSE,
		TEXTURE_SRC_CODE_EFFECT_LIGHTMAP_COLOR,
		TEXTURE_SRC_CODE_EFFECT_LIGHTMAP_SH,
		TEXTURE_SCR_CODE_SAVEGAME_SCREENSHOT,
		TEXTURE_SRC_CODE_EMBLEM_COLOR_ARRAY,
		TEXTURE_SRC_CODE_EMBLEM_NORMAL_ARRAY,
		TEXTURE_SRC_CODE_EMBLEM_SPECULAR_ARRAY,
		TEXTURE_SRC_CODE_PROCEDURAL,
		TEXTURE_SRC_CODE_SMAA_EDGES,
		TEXTURE_SRC_CODE_SMAA_BLEND,
		TEXTURE_SRC_CODE_SMAA_COLOR_0,
		TEXTURE_SRC_CODE_SMAA_COLOR_1,
		TEXTURE_SRC_CODE_SMAA_VELOCITY_0,
		TEXTURE_SRC_CODE_SMAA_VELOCITY_1,
		TEXTURE_SRC_CODE_SMAA_DEPTH_0,
		TEXTURE_SRC_CODE_SMAA_DEPTH_1,
		TEXTURE_SRC_CODE_SMAA_LUMA_1,
		TEXTURE_SRC_CODE_SMAA_LUMA_2,
		TEXTURE_SRC_CODE_SMAA_LUMA_3,
		TEXTURE_SRC_CODE_SMAA_FILMIC_HISTORY,
		TEXTURE_SRC_CODE_DIGITAL_DISTORTION,
		TEXTURE_SRC_CODE_WATERSHEETING_DISTORTION,
	...
	struct SndAlias
	{
		...
		const char PTR64 stopAliasName;
	...
	struct clipMap_t // __declspec(align(128))
	{
		...
		StaticModelCollisionModelList PTR64 staticModelCollisionModelLists; // transient collision models
	...
	struct MapEnts
	{
		...
		ClientEntAnchor PTR64 clientEntAnchors;
	...
	struct GfxReflectionProbe
	{
		...
		vec3_t origin;
		vec3_t angles;
		unsigned int PTR64 probeInstances;
	...
	struct GfxWorldDraw
	{
		...
		GfxDecalVolumeCollection PTR64 decalVolumeCollections;
		...
		GfxTexture PTR64 lightmapTextures;
		void PTR64 unused1;
		void PTR64 unused2;
		void PTR64 unused3;
	...
	struct GfxVoxelTree
	{
		...
		GfxVoxelTreeHeader PTR64 voxelTreeHeader;
		GfxVoxelTopDownViewNode PTR64 voxelTopDownViewNodeArray;
	...
	{
		unsigned int unk01Count;
		unsigned int PTR64 unk01; // unused
		unsigned int unk02Count;
		unsigned int PTR64 unk02; // unused
		unsigned int unk03Count;
		unsigned short PTR64 unk03;
...
#pragma pack(pop)
	...
	struct GfxLightAABB
	{
		...
		GfxLightAABBNode PTR64 nodeArray;
		unsigned short PTR64 lightArray;
	...
	struct GfxStaticModelVertexLightingInfo
	{
		...
		ID3D11Buffer PTR64 smodelLightingVb;
	...
	struct GfxWorldDpvsStatic
	{
		...
		unsigned int PTR64 smodelVisData[30];
		unsigned int PTR64 surfaceVisData[30];
		unsigned int PTR64 lodData;
		unsigned int PTR64 primaryLightVisData[1];
		unsigned int PTR64 reflectionProbeVisData[1];
		unsigned int PTR64 volumetricVisData[1];
		unsigned int PTR64 decalVisData[1];
		unsigned int PTR64 tessellationCutoffVisData[30]; // only [0] used
		unsigned int PTR64 sortedSurfIndex;
		GfxStaticModelInst PTR64 smodelInsts;
		GfxSurface PTR64 surfaces;
		GfxSurfaceBounds PTR64 surfacesBounds;
		...
		char PTR64 PTR64 constantBuffers;
		int usageCount;
	...
	struct GfxWorldDpvsDynamic
	{
		...
		unsigned int PTR64 dynEntCellBits[2];
		unsigned char PTR64 dynEntVisData[2][30];
	...
	struct GfxWorld
	{
		...
		GfxFrustumLights PTR64 frustumLights;
		GfxLightViewFrustum PTR64 lightViewFrustums;
		int voxelTreeCount;
		GfxVoxelTree PTR64 voxelTree;
		int heightfieldCount;
		GfxHeightfield PTR64 heightfields;
		...
		MaterialMemory PTR64 materialMemory;
		sunflare_t sun;
		float outdoorLookupMatrix[4][4];
		GfxImage PTR64 outdoorImage;
		Material PTR64 dustMaterial;
		float materialLod0SizeThreshold;
		unsigned int PTR64 cellCasterBits;
		unsigned int PTR64 cellHasSunLitSurfsBits;
		GfxSceneDynModel PTR64 sceneDynModel;
		GfxSceneDynBrush PTR64 sceneDynBrush;
		unsigned int primaryLightMotionDetectBitsEntries;
		unsigned int PTR64 primaryLightMotionDetectBits;
		unsigned int entityMotionBitsEntries;
		unsigned int PTR64 entityMotionBits;
		unsigned int staticSpotOmniPrimaryLightCountAligned;
		unsigned int numPrimaryLightEntityShadowVisEntries;
		unsigned int PTR64 primaryLightEntityShadowVis;
		unsigned int dynEntMotionBitsEntries[2];
		unsigned int PTR64 dynEntMotionBits[2];
		unsigned int numPrimaryLightDynEntShadowVisEntries[2];
		unsigned int PTR64 primaryLightDynEntShadowVis[2];
		GfxShadowGeometry PTR64 shadowGeomOptimized;
		GfxLightRegion PTR64 lightRegion;
		GfxLightAABB lightAABB;
		GfxWorldDpvsStatic dpvs;
		GfxWorldDpvsDynamic dpvsDyn;
		unsigned int mapVtxChecksum;
		unsigned int heroOnlyLightCount;
		GfxHeroOnlyLight PTR64 heroOnlyLights;
		unsigned int numUmbraGates;
		UmbraGate PTR64 umbraGates;
		unsigned int umbraTomeSize;
		char PTR64 umbraTomeData;
		umbraTomePtr_t umbraTomePtr;
		unsigned int numUmbraGates2;
		UmbraGate2 PTR64 umbraGates2;
		unsigned int umbraTomeSize2;
		char PTR64 umbraTomeData2;
		umbraTomePtr_t umbraTomePtr2;
		unsigned int umbraUnkSize;
		char PTR64 umbraUnkData;
	...
	struct PlayerAnimScript
	{
		...
		unsigned short PTR64 torsoAnimPackMap;
		unsigned short PTR64 torsoAnimUnpackMap;
		unsigned short PTR64 legsAnimPackMap;
		unsigned short PTR64 legsAnimUnpackMap;
	...
	struct WeaponAttachment
	{
		...
		float PTR64 locationDamage; // arr: 22
	...
	struct WeaponDef
	{
		...
		float PTR64 locationDamageMultipliers; // arr: 22
		unsigned char PTR64 hitLocPriorityMap; // arr: 22
	...
	struct WeaponCompleteDef
	{
		...
		scr_string_t PTR64 hideTags; // arr: 32
	...
	struct ScriptableDef // unchecked
	{
		...
		void PTR64 animationTreeDef[2]; // XAnim_s PTR64 animationTreeDef[2];
	...
	struct db_z_stream_s
	{
		...
		unsigned char PTR64 (__fastcall PTR64 zalloc)(unsigned char*, unsigned int, unsigned int);
		void(__fastcall PTR64 zfree)(unsigned char*, unsigned char*);
	...
	struct XZoneMemory
	{
		...
		char __pad0[4][24];
		void PTR64 unk1;
		XStreamFile PTR64 shared_ff_data;
