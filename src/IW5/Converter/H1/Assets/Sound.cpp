...
namespace ZoneTool::IW5
{
	namespace H1Converter
	{
		...
		H1::SoundDspBus channel_to_dspbus_index[IW5::SoundChannel::SND_CHANNEL_COUNT]
		{
			...
			H1::SoundDspBus::SND_DSPBUS_BATTLECHATTER,		//SND_CHANNEL_VOICE,
			...
			H1::SoundDspBus::SND_DSPBUS_VOICES_CRITICAL,	//SND_CHANNEL_ANNOUNCER,
		...
		H1::SoundDspBus volmod_to_dspbus[IW5::SoundVolMod::SND_VOLMOD_COUNT]
		{
			...
			H1::SoundDspBus::SND_DSPBUS_VOICES_CRITICAL,	//SND_VOLMOD_VOICEOVER_CRITICAL,
		...
		H1::SoundVolMod volmod_to_volmod_index[IW5::SoundVolMod::SND_VOLMOD_COUNT]
		{
			...
			H1::SoundVolMod::SND_VOLMOD_AMB_EMITTER,	//SND_VOLMOD_ELEMENT,
			...
			H1::SoundVolMod::SND_VOLMOD_CHATTER_FRIENDLY,	//SND_VOLMOD_CHATTERAL,
			H1::SoundVolMod::SND_VOLMOD_CHATTER_ENEMY,	//SND_VOLMOD_CHATTERRAX,
			H1::SoundVolMod::SND_VOLMOD_VOX_FRIENDLY,	//SND_VOLMOD_REACTIONAL,
			H1::SoundVolMod::SND_VOLMOD_VOX_ENEMY,	//SND_VOLMOD_REACTIONALMAX,
			H1::SoundVolMod::SND_VOLMOD_DIALOG,	//SND_VOLMOD_VOICEOVER,
			H1::SoundVolMod::SND_VOLMOD_DIALOG_RADIO,	//SND_VOLMOD_VOICEOVER_RADIO,
			H1::SoundVolMod::SND_VOLMOD_DIALOG_CRITICAL,	//SND_VOLMOD_VOICEOVER_CRITICAL,
			H1::SoundVolMod::SND_VOLMOD_DIALOG_AMB,	//SND_VOLMOD_VOICEOVER_AMB,
		...
		void GenerateH1SoundAlias(snd_alias_t* alias, H1::snd_alias_t* h1_alias, int index, allocator& mem, const std::function<std::string(const char* filename)>& get_streamed_sound_data)
		{
			...
			// dialog is battlechatter
			// dialog_critical is announcer
			if (h1_alias->volModIndex == H1::SND_VOLMOD_DEFAULT && h1_alias->dspBusIndex == H1::SND_DSPBUS_VOICES_CRITICAL)
			{
				h1_alias->volModIndex = H1::SND_VOLMOD_DIALOG_CRITICAL;
			}
			else if (h1_alias->volModIndex == H1::SND_VOLMOD_DEFAULT && h1_alias->dspBusIndex == H1::SND_DSPBUS_VOICES)
			{
				h1_alias->volModIndex = H1::SND_VOLMOD_DIALOG;
			}
		}
