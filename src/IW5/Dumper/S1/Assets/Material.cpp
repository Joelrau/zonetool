...
//#include "S1/Assets/Material.hpp"
...
namespace ZoneTool
{
	namespace S1
	{
		...
		{
			//	IW5,									S1
			{"wc_l_sm_a0c0",							"wc_l_sm_lmpb_a0c0_nfwpf_frt_aat"},
			{"wc_l_sm_r0c0",							"wc_l_sm_r0c0_nfwpf"},
			{"wc_l_sm_r0c0_nocast",						"wc_l_sm_r0c0_nfwpf_nocast"},
			{"wc_l_sm_r0c0d0n0s0",						"wc_l_sm_r0c0n0sd0_nfwpf"},		// couldn't find in S1, different from H1
			{"wc_l_sm_r0c0d0n0s0p0",					"wc_l_sm_r0c0n0sd0p0_nfwpf"},	// ^ same as above, but has p0 now
			...
			{"wc_l_sm_r0c0p0",							"wc_l_sm_r0c0p0_nfwpf"}, // not in H1, but found in S1
			//{"wc_l_sm_ua_r0c0n0s0p0_nocast",			"wc_l_sm_lmpb_ua_r0c0n0sd0sr0om0_nfwpf_nocast"}, // couldn't find & different from H1
			{"wc_l_sm_t0c0",							"wc_l_sm_t0c0_nfwpf"},			// wc_l_sm_t0c0_nfwpf is in S1 but not H1??
			{"wc_l_sm_t0c0n0",							"wc_l_sm_t0c0n0_nfwpf"},		// ^
			{"wc_l_sm_t0c0n0s0",						"wc_l_sm_t0c0n0sd0_nfwpf"},		// ^
			{"wc_l_sm_t0c0n0s0p0",						"wc_l_sm_t0c0n0sd0p0_nfwpf"},	// ^ (couldn't find in H1)
			{"wc_l_sm_t0c0q0n0s0",						"wc_l_sm_lmpb_t0c0q0n0sd0_nfwpf"},
			{"wc_l_sm_t0c0q0n0s0p0",					"wc_l_sm_lmpb_t0c0q0n0sd0_nfwpf"}, // couldn't find
			{"wc_l_sm_t0c0s0",							"wc_l_sm_t0c0sd0_nfwpf"},	// uses 1:1 techset name
			...
			{"wc_l_sm_b0c0d0n0",						"wc_l_sm_lmpb_ndw_b0c0d0n0sd0om0_nfwpf_frt_aat"}, // couldn't find in S1
			{"wc_l_sm_b0c0d0n0s0",						"wc_l_sm_lmpb_ndw_b0c0d0n0sd0om0_nfwpf_frt_aat"}, // couldn't find ^
			{"wc_l_sm_b0c0n0",							"wc_l_sm_lmpb_ndw_b0c0n0_nfwpf_frt_im_aat"},
			{"wc_l_sm_b0c0n0s0",						"wc_l_sm_lmpb_b0c0n0sd0_cltrans"}, // new name in S1
			{"wc_l_sm_b0c0n0s0p0",						"wc_l_sm_lmpb_b0c0n0sd0_cltrans"}, // couldn't find ^
			{"wc_l_sm_b0c0n0p0",						"wc_l_sm_ndw_b0c0n0p0_nfwpf_frt_im_aat"},	// found in S1? (couldn't find in H1)
			{"wc_l_sm_b0c0p0",							"wc_l_sm_ndw_b0c0p0_nfwpf_frt_aat"},		// found i think?
			{"wc_l_sm_b0c0s0",							"wc_l_sm_ndw_b0c0sd0_nfwpf_frt_aat"},			// new name in S1
			{"wc_l_sm_b0c0s0_nocast",					"wc_l_sm_ndw_b0c0sd0_nfwpf_nocast_frt_aat"},	// ^
			{"wc_l_sm_b0c0s0p0",						"wc_l_sm_ndw_b0c0sd0p0_nfwpf_frt_aat"},			// ^
			{"wc_l_sm_b0c0q0n0s0",						"wc_l_sm_ndw_b0c0q0n0sd0_nfwpf_frt_aat"}, // new name in S1
			{"wc_l_sm_b0c0q0n0s0p0",					"wc_l_sm_ndw_b0c0q0n0sd0_nfwpf_frt_aat"}, // couldn't find ^
			{"wc_l_sm_ua_b0c0n0s0p0_nocast",			"wc_l_sm_ndw_ua_b0c0n0sd0p0_nfwpf_nocast_frt_aat"},
			{"wc_l_sm_ua_b0c0q0n0s0p0_nocast",			"wc_l_sm_ndw_ua_b0c0q0n0sd0p0_nfwpf_nocast"}, // couldn't find in H1
			...
			{"wc_l_ua_b0c0_nocast",						"wc_l_ndw_ua_b0c0_nfwpf_nocast"}, // new name in S1
			...
			{"m_l_sm_b0c0s0",							"m_l_sm_lmpb_b0c0sd0_cltrans"},
			{"m_l_sm_b0c0n0s0p0",						"m_l_sm_ndw_b0c0sd0p0_cltrans"}, // idk...
			{"m_l_sm_b0c0q0n0s0",						"m_l_sm_b0c0q0n0sd0_cltrans"},
			{"m_l_sm_b0c0q0n0s0p0",						"m_l_sm_ndw_b0c0q0n0sd0p0_cltrans"}, // ^^

			{"mc_l_sm_a0c0",							"mc_l_sm_lmpb_a0c0_cltrans"},
			{"mc_l_sm_a0c0_nocast",						"mc_l_sm_lmpb_a0c0_nfwpf_nocast_frt_aat"},
			...
			{"mc_l_sm_flag_t0c0n0s0",					"mc_l_sm_flag_t0c0n0sd0_nfwpf"},
			{"mc_l_sm_flag_t0c0n0s0p0",					"mc_l_sm_flag_t0c0n0sd0_nfwpf"}, // couldn't find
			...
			{"mc_l_sm_scroll_t0c0n0s0",					"m_l_sm_scroll_t0c0n0sd0_nfwpf" }, // -> m

			{"mc_unlit",								"mc_unlit_blend_lin_ndw_cltrans_atlas"}, // couldn't find
			{"mc_unlit_nofog",							"mc_unlit_blend_lin_ndw_cltrans_atlas"}, // couldn't find
			{"mc_unlit_alphatest",						"mc_unlit_blend_lin_ndw_cltrans_atlas"}, // couldn't find
			...
			{"mc_unlit_blend_lin",						"mc_unlit_blend_lin_ndw_ua_nfwpf"},
			{"mc_unlit_multiply",						"mc_unlit_multiply_lin_ndw_nfwpf"}, // couldn't find
			{"mc_unlit_multiply_lin",					"mc_unlit_multiply_lin_ndw_nfwpf"},
			{"mc_unlit_falloff_add",					"mc_unlit_blend_lin_ndw_cltrans_atlas" }, // couldn't find
			...
			{"mc_effect_add_eyeoffset",					"mc_effect_blend_nofog_ndw"}, // couldn't find
			...
			{"mc_effect_zfeather_falloff_add_nofog",	"mc_effect_zf_falloff_add_nofog_ndw"},
			{"mc_effect_zfeather_falloff_add_nofog_eyeoffset", "mc_effect_zf_falloff_add_nofog_eo_ndw"},
			{"mc_effect_zfeather_falloff_add_lin_nofog", "mc_effect_zf_falloff_add_nofog_ndw"}, // couldn't find
			...
			{"distortion_scale_zfeather",				"distortion_scale_zf"},
			...
			{"effect_zfeather_falloff_screen",			"effect_zf_falloff_blend_ndw"}, // couldn't find
			...
			{"effect_zfeather_outdoor_blend_nofog",		"effect_zf_outdoor_blend_nofog_ndw_uvd" },
			{"effect_zfeather_screen",					"effect_zf_blend_ndw"},
			{"effect_zfeather_screen_eyeoffset",		"effect_zf_blend_ndw"}, // no eo
		...
		namespace
		{
			std::string get_s1_techset(std::string name, std::string matname, bool* result)
			{
				if (mapped_techsets.find(name) == mapped_techsets.end())
				{
					ZONETOOL_ERROR("Could not find mapped S1 techset for IW5 techset \"%s\" (material: %s)", name.data(), matname.data());
					*result = false;
					return "2d";
				}
				*result = true;
			...
			std::uint8_t get_h1_sortkey(std::uint8_t sortkey, std::string matname, std::string h1_techset)
			{
				...
				ZONETOOL_ERROR("Could not find mapped S1 sortkey for sortkey: %d (material: %s)", sortkey, matname.data());
			...
			std::uint8_t get_h1_camera_region(std::uint8_t camera_region, std::string matname, std::string h1_techset)
			{
				...
				{
					//return S1::CAMERA_REGION_LIT_DECAL;
				}
				...
				ZONETOOL_ERROR("Could not find mapped S1 camera region for camera region: %d (material: %s)", camera_region, matname.data());
		...
		void dump(Material* asset)
		{
			if (asset)
			{
				...
				if (asset->techniqueSet)
				{
					...
					bool result = false;
					h1_techset = S1::get_s1_techset(iw5_techset, asset->name, &result);
					if (!result)
					{
				...
				matdata["sortKey"] = S1::get_h1_sortkey(asset->info.sortKey, asset->name, h1_techset); // convert
				...
				matdata["cameraRegion"] = S1::get_h1_camera_region(asset->cameraRegion, asset->name, h1_techset);
				matdata["materialType"] = S1::get_material_type_from_name(asset->name);
				matdata["assetFlags"] = S1::MTL_ASSETFLAG_NONE;
